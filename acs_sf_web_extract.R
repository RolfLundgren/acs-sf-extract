...
#census_api_key <- 'e959ba9e3c73f3fbddf8e8886207815aa180f00d'
#end_year <- '2013'
#acs_length <- paste0('acs', '5')

#x <- fromJSON('http://api.census.gov/data/2012/acs5/profile?get=DP02_0001PE&for=state:*&key=e959ba9e3c73f3fbddf8e8886207815aa180f00d')
#colnames(x)

#y <- fromJSON(paste0('http://api.census.gov/data/2013/acs5?get=NAME,B01001_001E&for=county:*&in=state:51&key=', census_api_key))





# SOURCE WORK http://rstudio-pubs-static.s3.amazonaws.com/19337_2e7f827190514c569ea136db788ce850.html
# # getCensusApi
...
# 
# getCensusApi <- function(data_url,key = 'e959ba9e3c73f3fbddf8e8886207815aa180f00d', vars, region, numeric=TRUE){
#         if(length(vars)>50){
